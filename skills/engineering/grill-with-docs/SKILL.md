...
Ask the questions one at a time, waiting for feedback on each question before continuing. This is strict: never bundle two questions into one turn, even when they feel related. Bundling is tempting because it finishes faster, but later answers often depend on earlier ones — asking together makes the dependent question stale before it's answered.
