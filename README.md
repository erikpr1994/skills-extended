...
- **[improve-codebase-architecture](./skills/engineering/improve-codebase-architecture/SKILL.md)** — Find deepening opportunities in a codebase, informed by the domain language in `CONTEXT.md` and accepted decisions in `docs/adr/`.
...
- **[resume-handoff](./skills/productivity/resume-handoff/SKILL.md)** — Safely resume work from a handoff: check drift, re-probe unverified claims, and read the source of truth before acting.
